...
"""This script calculates quantile and plot per base coverage histogram from coverage files with per base resolutions"""
...
def calc_quantile(lst):
    ...
    for cov in lst:
        ...
        # df = df[ df['Total_Depth'] != 0] # exclude the 0 if R&D forgot to order some of the spikeins, normally not needed
