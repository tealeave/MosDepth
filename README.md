...
5. cal_quantile_plot_per_base.py: uses .coverage file generated by mosdepth.job to calculate uniformity metrics and plot per base coverage distribution
    - run in like `python cal_quantile_plot_per_base.py`
